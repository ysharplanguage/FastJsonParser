...
Finally, this parser/deserializer is/was a nice learning opportunity for me with parsing JSON, and to verify by myself once again what I had read about and experienced many times before. That is: never try to guess about performances, but instead always do your best to measure and find out where exactly the parsing and deserialization slowdowns (and memory consumption costs) actually come from.
