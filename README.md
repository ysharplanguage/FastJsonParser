...
(being able to parse JSON text coming from a stream is a must-have, IMO - "have mercy of your CLR's large object heap", if you see what I mean... - thus, similar support for StreamReader should be easy to add along the same line; coming soon hopefully)
